...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.getUserByToken = function (user) {
        // TODO: investigate how to return user without password
        return user;
    };
    UsersController.prototype.updateUserByToken = function (user, updateUserDto) {
    ...
    __decorate([
        ...
        openapi.ApiResponse({ status: 201, type: require("./users.schema").User }),
    ...
    __decorate([
        ...
        __param(0, (0, user_decorator_1.AuthedUser)())
    ], UsersController.prototype, "getUserByToken");
    __decorate([
        (0, common_1.UseGuards)(jwt_auth_guard_guard_1.JwtAuthGuard),
        (0, common_1.Patch)(),
        openapi.ApiResponse({ status: 200, type: Object }),
    ...
    ], UsersController.prototype, "updateUserByToken");
    __decorate([
