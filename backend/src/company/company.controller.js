...
var CompanyController = /** @class */ (function () {
    ...
    //fake register
    CompanyController.prototype.createCompany = function (company) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        saltOrRounds = 10;
                        return [4 /*yield*/, bcrypt.hash(company.password, saltOrRounds)];
                    case 1:
                        hashedPassword = _a.sent();
                        return [4 /*yield*/, this.companyService.createCompany(company.name, hashedPassword, company.email)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, { name: company.name, email: company.email }];
                }
            });
        });
    };
    CompanyController.prototype.getCompanyByToken = function (req) {
        return this.companyService.getCompanyByToken(req.user);
    };
    CompanyController.prototype.updateCompanyByToken = function (req, updatecompanyDto) {
        return this.companyService.updateCompanyByToken(req.user, updatecompanyDto);
    };
    CompanyController.prototype.remove = function (req) {
    ...
    ], CompanyController.prototype, "getCompanyByToken");
    __decorate([
        (0, common_1.UseGuards)(jwt_auth_guard_company_guard_1.JwtCompanyAuthGuard),
        (0, common_1.Patch)(),
        (0, swagger_1.ApiBearerAuth)(),
    ...
    ], CompanyController.prototype, "updateCompanyByToken");
    __decorate([
        (0, common_1.UseGuards)(jwt_auth_guard_company_guard_1.JwtCompanyAuthGuard),
        (0, common_1.Delete)(),
        (0, swagger_1.ApiBearerAuth)(),
